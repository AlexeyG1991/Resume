let ua = {
    ...
    experience_text_2: 'Я працював у невеликій компанії (10 осіб) до її закриття. Брав активну участь у розробці трьох проектів як верстальник.',
    personal_qualities: 'Особисті якості',
    personal_qualities_text: 'Шанувальник безперервної освіти для актуалізації знань. Готовий присвятити себе роботі. <br>Прагнення до професіоналізму, багатозадачність, стресостійкість, уміння працювати з конфіденційною інформацією, відповідальність, комунікабельність, організованість, уважність до деталей, аналітичне мислення.',
