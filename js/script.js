let rus = {
    ...
    experience_text_2: 'Работал в небольшой компании (10 человек) до ее закрытия. Принимал активное участие в разработке трех проектов в качестве верстальщика.',
...
let eng = {
    ...
    experience_text_2: 'I worked for a small company (10 people) until it closed. I took active part in develop of three projects as a layout designer.',
